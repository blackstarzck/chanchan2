...
> 참고
> 이 문서는 과거 npm 배포 이슈를 인계하기 위해 작성된 historical handoff 문서입니다.
> 본문에 남아 있는 일부 절대 경로와 명령 예시는 당시 작업 환경을 보존한 것이며, 현재 운영 기준 문서는 [`DEPLOYMENT-AND-OPERATIONS.md`](./DEPLOYMENT-AND-OPERATIONS.md), [`PUBLISHING-AND-OPERATIONS.ko.md`](./PUBLISHING-AND-OPERATIONS.ko.md), [`FRONTEND-DESIGN-SYNC-GUIDE.md`](./FRONTEND-DESIGN-SYNC-GUIDE.md)입니다.
...
- 운영 문서: [DEPLOYMENT-AND-OPERATIONS.md](./DEPLOYMENT-AND-OPERATIONS.md)
- 운영 문서 한국어판: [PUBLISHING-AND-OPERATIONS.ko.md](./PUBLISHING-AND-OPERATIONS.ko.md)
- 로드맵: [FIGMA-TO-CODE-ROADMAP.md](./FIGMA-TO-CODE-ROADMAP.md)
